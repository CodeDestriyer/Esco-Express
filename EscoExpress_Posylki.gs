...
function apiAddToRoute(params) {
  ...
  if (pkgRes.ok) {
    ...
    // Визначаємо адресу отримувача залежно від напряму
    var addrReceiver = pkg['Адреса в Європі'] || pkg['Місто Нова Пошта'] || '';
